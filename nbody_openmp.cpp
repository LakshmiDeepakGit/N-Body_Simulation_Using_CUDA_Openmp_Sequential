...
#define NUM_BODIES 2048  // Number of bodies
...
void compute_forces(std::vector<std::tuple<double, double, double>> &forces) {
...
void update_positions(const std::vector<std::tuple<double, double, double>> &forces) {
...
void run_simulation() {
    ...
    std::ofstream file("nbody_openmp_output.csv");
    file << "step,id,x,y,z\n";
